...
ENT.Base 			= "base_core3"
ENT.PrintName		= "Turret Core" -- The name the Core will come up as in the Spawnmenu
...
ENT.Purpose			= "Let me entertain you!" -- The purpose of the entity
...
ENT.Delay			= 5
ENT.Dir				= "turt" -- The name of your sub-folder, must be 4 characters.
/*---------------------------------------------------------
