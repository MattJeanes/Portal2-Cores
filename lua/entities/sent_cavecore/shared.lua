...
ENT.Base 			= "base_core3"
ENT.PrintName		= "Cave Johnson Core" -- The name the Core will come up as in the Spawnmenu
...
ENT.Purpose			= "Cave Johnson, We're done here." -- The purpose of the entity
ENT.Instructions	= "" -- The instructions of the entity, Perhaps "Insert 1 chocolate cookie to activate."
ENT.Category		= "Portal 2 Cores"
ENT.Animation		= "sphere_idle_neutral" -- Set's the animation of the core, Look in Portal 2 Authoring Tools for more info.
ENT.Delay			= 5
ENT.Dir				= "cave" -- The name of your sub-folder, must be 4 characters.
/*---------------------------------------------------------
